    ...
    <div class="col">
        <div class="form-group">
            ...
            <select id="country" class="form-control" name="country">
                <option value="{{\Auth::user()->info->country}}">{{\Auth::user()->info->country}}</option>
...
<div class="row">
    <div class="col">
        <div class="form-group">
            ...
            <input type="date"  class="form-control"  value="{{\Auth::user()->info->birthday}}" name="birthday">
        </div><!--form-group-->
    </div><!--col-->
</div><!--row-->
<div class="row">
    <div class="col">
        <div class="form-group">
            ...
            <input type="text" name="university" class="form-control" placeholder="University name" value="{{\Auth::user()->info->university}}">
        </div><!--form-group-->
    </div><!--col-->
</div><!--row-->
<div class="row">
    <div class="col">
        <div class="form-group">
            ...
            <select name="year" class="form-control" >
                <option value="{{\Auth::user()->info->universityYear}}">{{\Auth::user()->info->universityYear}}</option>
